    ...
    <div className="min-h-screen bg-background flex flex-col items-center">
      <main className="container mx-auto px-4 py-12 sm:px-6">
        ...
        <div className="mb-12 space-y-6 text-center">
          <span className="text-4xl sm:text-5xl font-bold space-x-3">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg">
            Explore the latest articles and stay updated
          </p>
          <Suspense>
            <ArticleSearchInput />
          </Suspense>
        ...
        <div className="mt-12 flex justify-center gap-2">
          ...
          <Link
            ...
            passHref
          >
            <Button variant="ghost" size="sm" disabled={currentPage === 1} className="transition-transform hover:scale-110">
              ← Prev
            </Button>
          </Link>
          ...
          {Array.from({ length: totalPages }).map((_, index) => (
            ...
            >
              <Button
                ...
                className="transition-all hover:bg-gradient-to-r from-blue-500 to-purple-500 hover:text-white"
              >
                {index + 1}
              </Button>
            </Link>
